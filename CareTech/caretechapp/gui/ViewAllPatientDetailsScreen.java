...
public class ViewAllPatientDetailsScreen extends javax.swing.JFrame {

    private DefaultTableModel model;
    public ViewAllPatientDetailsScreen() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jtViewAllPatients.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "P_ID", "F_NAME", "S_NAME", "OPD", "AGE", "GENDER", "M_STATUS", "P_DATE", "ADDRESS", "CITY", "PHONE_NO", "DOCTOR_ID"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewAllPatientDetailsScreen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewAllPatientDetailsScreen().setVisible(true);
            }
        });
    }
...
private void loadAllPatientDetails() {
        try{
            ...
            JOptionPane.showMessageDialog(null,"Error In View All Patient  Receptionist DB");
            ex.printStackTrace();
